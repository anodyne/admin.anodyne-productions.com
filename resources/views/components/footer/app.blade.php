  ...
  <div class="flex flex-col items-center justify-between gap-5 border-t border-slate-900/5 pt-8 dark:border-white/5 sm:flex-row">
    ...
    <div class="flex items-center gap-4">
      ...
      <a href="https://patreon.com/anodyneproductions" target="_blank" class="group">
        ...
        <svg viewBox="0 0 569 546" xmlns="http://www.w3.org/2000/svg" class="h-4 w-auto fill-slate-400 dark:fill-slate-500 transition group-hover:fill-slate-500 dark:group-hover:fill-slate-400" aria-hidden="true"><g><circle cx="362.589996" cy="204.589996" r="204.589996"></circle><rect height="545.799988" width="100" x="0" y="0"></rect></g></svg>
      </a>
    </div>
  </div>
</footer>